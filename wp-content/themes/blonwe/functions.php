...
function blonwe_admin_styles() {
    ...
    wp_enqueue_script('blonwe-register',    get_template_directory_uri() .'/assets/js/admin/register.js', array('jquery'), '1.0', true);
}
...
function blonwe_scripts() {
	...
	if ( is_admin_bar_showing() ) {
		wp_enqueue_style( 'blonwe-klbtheme', BLONWE_INDEX_CSS . '/admin/klbtheme.css', false, '1.0');    
	}	

	if ( is_singular() ) wp_enqueue_script( 'comment-reply' );

	wp_enqueue_style( 'bootstrap', 							BLONWE_INDEX_CSS . '/bootstrap.min.css', false, '1.0');
	wp_register_style( 'mediaelementplayer', 				BLONWE_INDEX_CSS . '/mediaelementplayer.min.css', false, '1.0');
	wp_enqueue_style( 'scrollbar', 							BLONWE_INDEX_CSS . '/perfect-scrollbar.css', false, '1.0');
	wp_enqueue_style( 'slick-slider', 						BLONWE_INDEX_CSS . '/slick-slider.css', false, '1.0');
	wp_enqueue_style( 'magnific-popup', 					BLONWE_INDEX_CSS . '/magnific-popup.css', false, '1.0');
	wp_enqueue_style( 'blonwe-storebox', 					BLONWE_INDEX_CSS . '/storebox.css', false, '1.0');
	wp_enqueue_style( 'blonwe-contact', 					BLONWE_INDEX_CSS . '/contact.css', false, '1.0');
	wp_enqueue_style( 'blonwe-blog-single', 				BLONWE_INDEX_CSS . '/blog-single.css', false, '1.0');
	wp_enqueue_style( 'blonwe-order-tracking', 				BLONWE_INDEX_CSS . '/order-tracking.css', false, '1.0');
	wp_enqueue_style( 'select2-min', 						BLONWE_INDEX_CSS . '/select2.min.css', false, '1.0');
	wp_enqueue_style( 'blonwe-base', 						BLONWE_INDEX_CSS . '/base.css', false, '1.0');
	wp_style_add_data( 'blonwe-base', 'rtl', 'replace' );
	wp_enqueue_style( 'blonwe-base-dark', 					BLONWE_INDEX_CSS . '/base-dark.css', false, '1.0');
	...
	wp_enqueue_script( 'gsap-bundle',    	    	BLONWE_INDEX_JS . '/gsap.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'waypoints',    	    	    BLONWE_INDEX_JS . '/waypoints.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'sticky',    	    	    BLONWE_INDEX_JS . '/sticky.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'perfect-scrollbar-min',    	BLONWE_INDEX_JS . '/perfect-scrollbar.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'select2-full-min',    	    BLONWE_INDEX_JS . '/select2.full.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'slick',    	    	        BLONWE_INDEX_JS . '/slick.min.js', array('jquery'), '1.0', true);
	wp_register_script( 'blonwe-googlemap',         '//maps.googleapis.com/maps/api/js?key='. $mapkey .'', array('jquery'), '1.0', true);
	wp_enqueue_script( 'jquery-countdown',    	    BLONWE_INDEX_JS . '/jquery.countdown.min.js', array('jquery'), '1.0', true);
	wp_register_script( 'theia-sticky-sidebar',    	BLONWE_INDEX_JS . '/theia-sticky-sidebar.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'jquery-magnific-popup',    	BLONWE_INDEX_JS . '/jquery.magnific-popup.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'bootstrap-bundle',    	    BLONWE_INDEX_JS . '/bootstrap.bundle.min.js', array('jquery'), '1.0', true);
	wp_register_script( 'mediaelement-and-player',  BLONWE_INDEX_JS . '/mediaelement-and-player.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'blonwe-siteslider',    	 	BLONWE_INDEX_JS . '/custom/siteslider.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'blonwe-countdown',        	BLONWE_INDEX_JS . '/custom/countdown.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'blonwe-layered-dropdown',   BLONWE_INDEX_JS . '/custom/layered-dropdown.js', array('jquery'), '1.0', true);
	wp_register_script( 'blonwe-stickysidebar',     BLONWE_INDEX_JS . '/custom/stickysidebar.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'blonwe-productquantity',    BLONWE_INDEX_JS . '/custom/productquantity.js', array('jquery'), '1.0', true);
	wp_register_script( 'blonwe-hoverslider',       BLONWE_INDEX_JS . '/custom/hoverslider.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'blonwe-productHover',       BLONWE_INDEX_JS . '/custom/productHover.js', array('jquery'), '1.0', true);
	wp_register_script( 'blonwe-sidebarfilter',     BLONWE_INDEX_JS . '/custom/sidebarfilter.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'blonwe-sitescroll',     	BLONWE_INDEX_JS . '/custom/sitescroll.js', array('jquery'), '1.0', true);
	wp_register_script( 'blonwe-cartquantity',    	BLONWE_INDEX_JS . '/custom/cartquantity.js', array('jquery'), '1.0', true);
	wp_register_script( 'blonwe-flex-thumbs',       BLONWE_INDEX_JS . '/custom/flex-thumbs.js', array('jquery'), '1.0', true);
	wp_register_script( 'blonwe-popup-login',       BLONWE_INDEX_JS . '/custom/popup-login.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'blonwe-theme-select',     	BLONWE_INDEX_JS . '/custom/theme-select.js', array('jquery'), '1.0', true);
	wp_register_script( 'blonwe-mini-cart-scroll',  BLONWE_INDEX_JS . '/custom/mini_cart_scroll.js', array('jquery'), '1.0', true);
	wp_register_script( 'blonwe-loginform',   		BLONWE_INDEX_JS . '/custom/loginform.js', array('jquery'), '1.0', true);
	if ( is_rtl() ) {
	wp_enqueue_script( 'bundle-rtl',    	    	BLONWE_INDEX_JS . '/bundle-rtl.js', array('jquery'), '1.0', true);
	} else {
	wp_enqueue_script( 'bundle',    	    	 	BLONWE_INDEX_JS . '/bundle.js', array('jquery'), '1.0', true);
	}
...
function blonwe_icon_styles() {
	...
	if(in_array('auto-part', $icon_css_multicheck)){
		wp_enqueue_style( 'icon-auto-part', 					BLONWE_INDEX_CSS . '/klbtheme-icon-auto-part.css', false, '1.0');
	}
	if(in_array('interface', $icon_css_multicheck)){
		wp_enqueue_style( 'icon-interface', 					BLONWE_INDEX_CSS . '/klbtheme-icon-interface.css', false, '1.0');
	}
	if(in_array('ecommerce', $icon_css_multicheck)){
		wp_enqueue_style( 'icon-ecommerce', 					BLONWE_INDEX_CSS . '/klbtheme-icon-ecommerce.css', false, '1.0');
	} 
	if(in_array('delivery', $icon_css_multicheck)){
		wp_enqueue_style( 'icon-delivery', 						BLONWE_INDEX_CSS . '/klbtheme-icon-delivery.css', false, '1.0');
	} 
	if(in_array('furniture', $icon_css_multicheck)){
		wp_enqueue_style( 'icon-furniture', 					BLONWE_INDEX_CSS . '/klbtheme-icon-furniture.css', false, '1.0');
	} 
	if(in_array('grocery', $icon_css_multicheck)){
		wp_enqueue_style( 'icon-grocery', 						BLONWE_INDEX_CSS . '/klbtheme-icon-grocery.css', false, '1.0');
	} 
	if(in_array('electronics', $icon_css_multicheck)){
		wp_enqueue_style( 'icon-electronics', 					BLONWE_INDEX_CSS . '/klbtheme-icon-electronics.css', false, '1.0');
	} 
	if(in_array('organic', $icon_css_multicheck)){
		wp_enqueue_style( 'icon-organic', 						BLONWE_INDEX_CSS . '/klbtheme-icon-organic.css', false, '1.0');
	} 
	
	wp_enqueue_style( 'icon-social', 						BLONWE_INDEX_CSS . '/klbtheme-icon-social.css', false, '1.0');
