...
<header id="masthead" class="site-header <?php echo esc_attr($headertransparent); ?> header-type5">
    <div class="header-desktop min-1200">
    
        <div class="header-row header-topbar color-scheme-dark color-layout-light background-white border-bottom border-light-10">
			<div class="container">
        ...
        <div class="header-row header-main color-scheme-dark color-layout-white border-bottom border-theme-10">
			<div class="container">
				<div class="header-inner d-flex">
						...
						<?php $elementor_page = get_post_meta( get_the_ID(), '_elementor_edit_mode', true ); ?> 
							...
							<?php if($elementor_page){ ?>
								<a href="<?php echo esc_url( home_url( "/" ) ); ?>" title="<?php bloginfo("name"); ?>">
									...
									<?php } else { ?>
										<img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-electronic.png" width="173" height="44" alt="<?php bloginfo("name"); ?>" class="dark-logo">
									<?php } ?>
