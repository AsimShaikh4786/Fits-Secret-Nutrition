...
function blonwe_register_theme() {
	...
	add_submenu_page( 'klbtheme_options', esc_html__('Theme Options', 'blonwe'), esc_html__('Theme Options', 'blonwe'), 'manage_options', 'customize.php?return=%2Fblonwe%2Fwp-admin%2Fadmin.php%3Fpage%3Dklbtheme_options' );
}
