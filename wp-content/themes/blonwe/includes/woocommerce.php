...
function blonwe_product_second_image(){
	...
	if($product_image_ids && get_theme_mod('blonwe_product_box_gallery') == 'type3'){
		...
		echo '</div>';
		echo '</a>';
	} elseif($product_image_ids && get_theme_mod('blonwe_product_box_gallery') == 'type2'){
...
function blonwe_shop_box () {
	...
	$stockprogressbar = get_theme_mod('blonwe_product_box_stock_progress_bar') == 1 ? 'true' : '';
	$stockstatus = get_theme_mod('blonwe_product_box_stock_status') == 1 ? 'true' : '';
	$shippingclass = get_theme_mod('blonwe_product_box_shipping_class') == 1 ? 'true' : '';
	$countdown = get_theme_mod('blonwe_product_box_countdown') == 1 ? 'true' : '';
	...
	if(blonwe_shop_view() == 'list_view' || $postview == 'list_view') {
		...
		echo blonwe_product_type13($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else if(get_theme_mod('blonwe_product_box_type') == 'type12'){
		echo blonwe_product_type12($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else if(get_theme_mod('blonwe_product_box_type') == 'type11'){
		echo blonwe_product_type11($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else if(get_theme_mod('blonwe_product_box_type') == 'type10'){
		echo blonwe_product_type10($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else if(get_theme_mod('blonwe_product_box_type') == 'type9'){
		echo blonwe_product_type9($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else if(get_theme_mod('blonwe_product_box_type') == 'type8'){
		echo blonwe_product_type8($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else if(get_theme_mod('blonwe_product_box_type') == 'type7'){
		echo blonwe_product_type7($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else if(get_theme_mod('blonwe_product_box_type') == 'type6'){
		echo blonwe_product_type6($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else if(get_theme_mod('blonwe_product_box_type') == 'type5'){
		echo blonwe_product_type5($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else if(get_theme_mod('blonwe_product_box_type') == 'type4'){
		echo blonwe_product_type4($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else if(get_theme_mod('blonwe_product_box_type') == 'type3'){
		echo blonwe_product_type3($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} elseif (get_theme_mod('blonwe_product_box_type') == 'type2'){
		echo blonwe_product_type2($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	} else {
		echo blonwe_product_type1($stockprogressbar, $stockstatus, $shippingclass, $countdown);
	}
}
...
function blonwe_body_classes( $classes ) {
	...
	if( get_theme_mod('blonwe_shop_width') == 'wide' || blonwe_get_option() == 'wide' && is_shop()) { 
		$classes[] = 'shop-wide';
	}elseif( get_theme_mod('blonwe_single_full_width') == 1 || blonwe_get_option() == 'wide' && is_product()) { 
		$classes[] = 'shop-wide';
	} else {
		$classes[] = '';
	}
